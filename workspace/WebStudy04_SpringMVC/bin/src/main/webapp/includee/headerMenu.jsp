...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap w-100 p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="${pageContext.request.contextPath}/index.do">홈화면</a>
  ...
  <ul class="nav px-3 col">
    ...
    <li class="nav-item text-nowrap">
      <a class="nav-link" href="${pageContext.request.contextPath}/prod">상품 관리</a>
    </li>
    <li class="nav-item text-nowrap">
