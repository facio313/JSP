...
<header class="ks-header nav-bar bg-transparentt radius">
    <nav class="navbar navbar-expand-lg navbar-light py-0 px-4 bg-transparent radius">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="navbar-nav ms-auto">
                <a href="${pageContext.request.contextPath}/pr" class="nav-item nav-link active">인재홍보</a>
            </div>
            <div class="navbar-nav ms-auto">
                <a href="${pageContext.request.contextPath}/expert" class="nav-item nav-link active">유료상품</a>
            </div>
            <div class="navbar-nav ms-auto">
            ...
            <div class="nav-item dropdown ms-auto">
                ...
                <div class="dropdown-menu rounded-0 m-0">
                    <a href="<c:url value='/noticeList'/>" class="dropdown-item">공지사항</a>
