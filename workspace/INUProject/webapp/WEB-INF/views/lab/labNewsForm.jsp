      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8 mb-5 mb-lg-0">
            ...
            <form action="<%=request.getContextPath() %>/lab/News/Insert" method="post"> 
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-black" for="text">기사 제목</label> 
             		<input type="text" id="newsName" name="newsName" class="form-control" placeholder="제목을 입력하세요">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-black" for="text">기사 내용</label>
             		<textarea id="newsContent" name="newsContent" cols="30" rows="7" class="form-control" placeholder="내용을 입력하세요"></textarea>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="submit" value="기사 등록하기" class="btn btn-primary text-white" style="float: right;">
                </div>
              </div>
