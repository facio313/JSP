...
<!-- 												  </tr> -->
							...
							<div class="wrap_story_panel" style="padding-bottom: 0;">
								<div class="wrap_section wrap_community_topic">		
									<form:form modelAttribute="apply" action="${pageContext.request.contextPath}/apply/${apply.applySn}" method="put">
										<div class="section_inner" style="margin-right:15px">
											<div class="tblType">
												<div style="width: 100%;">
										...
										<div style="display: flex; justify-content: flex-end; padding: 7rem; padding-top: 1rem; padding-right: 0.5rem; padding-bottom: 0;">
											<button class="btn btn-primary" type="submit" style="width: 150px; height: 50px; border-radius: 0;">저장</button> 
											<button class="btn btn-danger" type="button" onclick='location.href="${pageContext.request.contextPath}/apply/${apply.applySn}"' style="width: 150px; height: 50px; border-radius: 0;">취소</button> 
										</div>
									</form:form>
								</div>
							</div>
											...
											<table style="width: 100%;">
												...
												<tbody>
													<tr>
														...
														<td id="myintroGrowth">${apply.myintro.myintroGrowth}</td>
														<td id="myintroPersonality">${apply.myintro.myintroPersonality}</td>
														<td>· · ·</td>
