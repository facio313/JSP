...
<html lang="en">
  <head>
    ...
    <!-- boardLayout CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/interview.css" />
    <!-- boardLayout CSS -->
          ...
          <div class="recruilt_list_wrap wrap_job_interview">
            <div class="list_info">
              <div class="searchTypoBox">
                <form name="frm" id="frm" method="get" action="/zf_user/career-information/senior-list">
                  <input type="hidden" name="cat_mcls" id="cat_mcls" value="">
                  <input type="text" class="inpTypo" name="keyword" id="search_keyword" value="" style="width:230px"
                    placeholder="제목 또는 기업명을 입력하세요.">
                  <button type="submit" class="btnTypoSearch" id="btn_company_search"
            ...
            <div class="job_interview_list" id="listTop">
              <ul>
                <li>
                  <a href="${pageContext.request.contextPath }/interview/detailInterview" class="inlist_box">
                    <p class="sub_title"><span class="in_subtit">앱개발, 유지보수, Flutter</span></p>
                    <p class="title"><em>앱 서비스 신규 기능 개발 및 유지보수를 담당해요</em></p>
                    <div class="box_info">
                      <div class="txt_detail">
                        <p class="company_name">세븐미어캣</p>
                        <p class="company_part">
                          <em class="inpart">플랫폼기술사업본부</em>
                          <em class="inname">라온</em>
                        </p>
                        <p class="day_line">
                          <span class="day">23.02.01</span>
                          <span class="view_count">93</span>
                        </p>
                      </div>
                      <div class="img_view"><span class="img"><img
                            src="https://pds.saramin.co.kr/career-information/asset_thumbnail/202302/01/rpdolq_63pd-2so1pr_asset.png"
                            alt="직무인터뷰 관계자 사진"></span></div>
                    </div>
                  </a>
                </li>
