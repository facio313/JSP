...
.help_find .type2 .inp_find {width: 659px;}
.help_find li.col_type .inp_find {width: 254px;}
.help_find .type2 .wrap_input {width: 600px;}
								...
								<fieldset>
									...
									<ul class="list_find type2">
										...
										<li class="col_type">
											...
											<div class="wrap_input">
												<span class="box_input">
													<form:input type="text" path="incumName" id="incumName" class="inp_find" required="required" placeholder="작성자를 입력해주세요" />
												</span>
											</div>
											<div class="wrap_lab">
										...
										<li>
											<div class="wrap_lab" style="padding:35px 0 0 0px;">
												<label for="topTitle" class="lab_find" style="text-align:center;">상위제목</label>
											</div>
											<div class="wrap_input">
												<span class="box_input">
										...
										<li>
											<div class="wrap_lab" style="padding:35px 0 0 0px;">
												<label for="help_upload" class="lab_find" style="text-align:center;">파일첨부</label>
											</div>
											<div class="wrap_input">
												...
												<div class="wrap_file" style="width:661px">
												...
												<p class="noti_inp">10MB 이하의 hwp, pdf, zip, MS Office 파일, 이미지 파일(JPG, GIF, PNG, BMP) 만 등록 가능합니다.</p>
											</div>
										</li>
									</ul>
									<!-- //////////////////////////////// question 시작 ////////////////////////////////////////// -->
									<div id="add_question">
										<div id="divSample" class="col-100">
											...
											<div class="form-group">
												...
												<form:textarea path="answer1" class="form-control textIncumContent" id="editor" placeholder="답변을 입력해주세요"></form:textarea>
											</div>
										</div>
									</div>
									...
									<div class="row align-items-center mb-5">
										<div class="col-lg-4 ml-auto">
											<div class="row">
												<div class="col-6">
													<button type="submit" class="btn btn-block btn-primary btn-md" style="padding:12px 0px 12px 0px;">게시글 등록</button>
												</div>
												<div class="col-6">
