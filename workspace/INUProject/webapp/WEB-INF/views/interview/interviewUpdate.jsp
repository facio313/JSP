			...
			<div class="row mb-5">
				<div class="col-lg-12">
					<form:form enctype="multipart/form-data"
						class="p-4 p-md-5 border rounded" method="post" modelAttribute="interview">
						...
						<form:input type="hidden" path="incumNo"/>
						<div class="form-group">
							<label for="job-title">직무명</label>
							<form:input class="form-control" id="job-title" path="jobName" placeholder="직무명을 입력해주세요" />
						</div>

						<div class="form-group">
							<label for="job-title">부서명</label>
							<form:input class="form-control" id="job-title" path="department" placeholder="부서명을 입력해주세요" />
						</div>


						<div class="form-group">
							<label for="job-title">작성자</label>
							<form:input class="form-control" id="job-title" path="incumName" placeholder="작성자를 입력해주세요" />
						</div>

						<div class="form-group">
							<label for="job-title">제목</label>
							<form:input class="form-control" id="job-title" path="incumTitle" placeholder="제목을 입력해주세요" />
						</div>

						<div class="form-group">
							<label for="job-title">서브제목</label>
							<form:input class="form-control" id="job-title" path="subTitle" placeholder="서브제목을 입력해주세요" />
						</div>

						<div class="form-group">
						<label for="job-description"></label>
						<form:textarea path="incumContent" class="form-control" id="editor"></form:textarea>
						</div>
