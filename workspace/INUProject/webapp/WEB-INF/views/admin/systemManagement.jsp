...
<div class="site-wrap">
    ...
    <section class="py-5 bg-image overlay-primary fixed overlay" id="next-section" style="background-image: url('resources/images/hero_1.jpg');">
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <a data-fancybox data-ratio="2" href="https://vimeo.com/317571768" class="block__96788">
              ...
              <img src="resources/images/Dobby.jpg" alt="Image" class="img-fluid img-shadow">
            </a>
          </div>
