...
<div class="top-bar" style="position: relative; left: -20px; background-color: #126CF5; width: 100%; height: 200px; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
