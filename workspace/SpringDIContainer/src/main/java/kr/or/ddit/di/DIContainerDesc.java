...
/**
 * String DI Container, IoC Container, Spring Container, Bean Container
 * 
 ...
 * 컨테이너 빈 관리 정책
 * 
 * 1. 특별한 설정(scope)이 없는 한 등록된 모든 반은 싱글턴으로 관리,
...
//		
//		SampleDAO dao = context.getBean("sampleDAOImpl_Oracle", SampleDAO.class);
