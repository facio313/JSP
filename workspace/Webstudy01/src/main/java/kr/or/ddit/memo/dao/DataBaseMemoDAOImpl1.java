...
public class DataBaseMemoDAOImpl1 implements MemoDAO {
	
	private DataBaseMemoDAOImpl1() {
		super();
	}
	
	private static DataBaseMemoDAOImpl1 dao;

	public static DataBaseMemoDAOImpl1 getInstance() {
		if (dao == null)
			dao = new DataBaseMemoDAOImpl1();
		return dao;
	}
